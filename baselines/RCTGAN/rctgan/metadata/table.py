...
class Table:
    ...
    _TRANSFORMER_TEMPLATES = {
        ...
        'categorical': rdt.transformers.categorical.FrequencyEncoder(),
        'categorical_fuzzy': rdt.transformers.categorical.FrequencyEncoder(add_noise=True),
        'one_hot_encoding': rdt.transformers.categorical.OneHotEncoder(),
        'label_encoding': rdt.transformers.categorical.LabelEncoder(),
        'boolean': rdt.transformers.boolean.BinaryEncoder(),
        'datetime': rdt.transformers.datetime.OptimizedTimestampEncoder(),
    }
    _DTYPE_TRANSFORMERS = {
        'i': 'integer',
        'f': 'float',
    ...
    def _fit_hyper_transformer(self, data, extra_columns):
        ...
        self._hyper_transformer.detect_initial_config(data[list(transformers_dict.keys())])
    ...
    def transform(self, data, on_missing_column='error'):
        ...
        try:
            return self._hyper_transformer.transform(data[self._hyper_transformer.field_transformers.keys()])
