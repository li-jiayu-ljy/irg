...
def main():
    ...
    meta.update_column("games", "homeTeamPlayID", sdtype="id")
    meta.update_column("games", "awayTeamPlayID", sdtype="id")
    meta.update_column("shots", "shootAppearanceID", sdtype="id")
    meta.update_column("shots", "assistAppearanceID", sdtype="id")
    meta.remove_relationship("gamestats", "appearances")
    meta.remove_relationship("games", "teamstats")
    meta.add_relationship("teamstats", "games", "teamplayID", "homeTeamPlayID")
    meta.add_relationship("teamstats", "games", "teamplayID", "awayTeamPlayID")
    meta.add_relationship("appearances", "shots", "appearanceID", "shootAppearanceID")
    meta.add_relationship("appearances", "shots", "appearanceID", "assistAppearanceID")
